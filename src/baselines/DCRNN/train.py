...
def main(config):
    ...
    graph_pkl_filename = 'C:\\Users\\6\\PycharmProjects\\FORECASTING_GNN\\benchmark data\\HOSP\\hosp_adj.csv'
    # _, _, adj_mat = utils.load_graph_data(graph_pkl_filename)
    adj_mat = utils.load_graph_data(graph_pkl_filename)
    data = utils.load_dataset(dataset_dir='data/',
...
if __name__ == '__main__':
    ...
    args.add_argument('-c', '--config', default='C:\\Users\\6\\PycharmProjects\\FORECASTING_GNN\\baselines\\DCRNN\\config.json', type=str,
