...
from baselines.GMAN.utils.utils_ import log_string, plot_train_val_loss
from baselines.GMAN.utils.utils_ import count_parameters, load_data

from baselines.GMAN.model.model_ import GMAN
from baselines.GMAN.model.train import train
from baselines.GMAN.model.test import test
...
parser.add_argument('--traffic_file', default='./data/pems-bay.h5',
                    help='traffic file')
parser.add_argument('--SE_file', default='./data/SE(hosp).txt',
...
parser.add_argument('--log_file', default='./data/log',
                    help='log file')
parser.add_argument('--data', default='HOSP', help='Specify the dataset')
