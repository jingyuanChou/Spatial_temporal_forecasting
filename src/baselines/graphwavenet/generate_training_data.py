...
def generate_train_val_test(args):
    ...
    df = pd.read_csv(
        'C:\\Users\\6\\PycharmProjects\\FORECASTING_GNN\\benchmark data\\HOSP\\hosp_weekly_filt_case_data.csv')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seq_length_y", type=int, default=4, help="Sequence Length.",)
    parser.add_argument("--y_start", type=int, default=1, help="Y pred start", )
    parser.add_argument("--dow", action='store_true',default=False)
